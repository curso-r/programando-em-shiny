...
O `shinydasboard` é um pacote que introduz diversas ferramentas para o Shiny. A principal é um novo layout, dividido em três áreas:
...
Você pode customizar o visual do seu aplicativo utilizando CSS. Nesta seção, falaremos apenas como adicionar CSS ao Shiny. Uma introdução formal ao CSS será feita no Capítulo @html-css-js.
